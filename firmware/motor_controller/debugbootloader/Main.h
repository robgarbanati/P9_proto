...
#define SAFETY_CLIP_GPIO		GPIOA
#define RIGHT_SAFETY_CLIP		DRVGPIO_PIN_7
#define RIGHT_SAFETY_CLIP_GPIO_OFFSET		7
#define LEFT_SAFETY_CLIP		DRVGPIO_PIN_8
#define LEFT_SAFETY_CLIP_GPIO_OFFSET		8
