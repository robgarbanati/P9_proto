...
#define PHASE_ESTIMATION_RESOLUTION 13  //  minimum number of points needed to sample while sound is travelling from one mic to another (in the longest case) to get useful phase estimates
...
#define ADC_BUFFER_SIZE 750 //(NUM_STF_WAVES_PER_BUFFER*PHASE_ESTIMATION_RESOLUTION)
